...
*/
	 ...
	 */
	$config['admin_email']		   = "leonel@leonelfolmer.com";
     ...
     * Default : auth/
	 **/
	$config['email_templates']     = 'email_admin/';
	 ...
	 **/
	$config['email_forgot_password']   = 'esqueceu.tpl.php';
 
	/**
	 * Forgot Password Complete Email Template
     * Default : new_password.tpl.php
	 **/
	$config['email_forgot_password_complete']   = 'nova_senha.tpl.php';  
